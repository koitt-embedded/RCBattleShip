 ...
 * Use this instead of directly setting GRER/GFER.
  * SA1100 IRQ를위한 GPIO 에지 감지 :
  * IRQ는 Falling-Edge, Rising-Edge 또는 둘 다에서 생성됩니다.
  * GRER / GFER를 직접 설정하는 대신에 이것을 사용하십시오.
 */
 ...
 * and call the handler.
 IRQ 0-11 (GPIO) 핸들러. 우리는 여기에 irq_controller_lock을 넣고 IRQ를 비활성화하여 입력합니다. IRQ를 디코드하고 핸들러를 호출하십시오.
 */
...
void __init sa1100_init_gpio(void)
{
	 ...
	 * Install handlers for GPIO 0-10 edge detect interrupts
	   GPIO 0-10 가장자리 감지 인터럽트를위한 핸들러 설치
	 */
