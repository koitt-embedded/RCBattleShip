 ...
 * General Public License for more details.
  ...
  *
  * 이 프로그램은 무료 소프트웨어입니다. 너는 재배포 할 수있어.
  * ACCES 104-IDIO-16 제품군 용 GPIO 드라이버
  * Copyright (C) 2015 William Breathitt Gray
  *
  * 이 프로그램은 무료 소프트웨어입니다. Free Software Foundation에 의해 공표 된 GNU 일반 공중 사용 허가서, 버전 2의 조건에 따라 재배포 및 / 또는 수정할 수 있습니다.
  *
  * 이 프로그램은 유용 할 것이라는 희망으로 배포되었지만 어떠한 보증도하지 않습니다. 상품성 또는 특정 목적에의 적합성에 대한 묵시적인 보증조차하지 않습니다. 자세한 내용은 GNU General Public License를 참조하십시오. 라이센스 버전 2 또는 귀하의 선택에 따라 최신 버전을 선택하십시오.
 */
 ...
 * @out_state:	output bits state
  * struct idio_16_gpio - GPIO 장치 개인 데이터 구조
  * @chip : gpio_chip의 인스턴스
  * @lock : gpio_set 경쟁 조건을 방지하는 동기화 잠금
  * @base : GPIO 장치의 기본 포트 주소
  * @extent : GPIO 장치의 포트 주소 영역 범위
  * @out_state : 출력 비트 상태
 */
struct idio_16_gpio {
