 ...
 */
/**
  * struct crystalcove_gpio - 크리스탈 코브 GPIO 컨트롤러
  * @buslock : 버스 잠금 / 동기화 및 잠금 해제 용.
  * @chip : 추상 gpio_chip 구조체입니다.
  * @regmap : 상위 장치의 regmap.
  * @ 업데이트 : 잠금 해제시 칩에 쓰게 될 보류중인 IRQ 설정 업데이트.
  * @intcnt_value : 기록 될 인터럽트 감지 값.
  * @set_irq_mask : IRQ 마스크를 설정해야하는 경우에는 true이고 해제하려면 false입니다.
  */
