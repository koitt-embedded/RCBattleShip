 ...
 */
/**
  struct pch_gpio_reg_data - 레지스터 저장 데이터.
  * @ien_reg : IEN 레지스터의 내용을 저장합니다.
  * @imask_reg : IMASK 레지스터의 내용을 저장합니다.
  * @po_reg : PO 레지스터의 내용을 저장합니다.
  * @pm_reg : PM 레지스터의 내용을 저장합니다.
  * @ im0_reg : IM0 레지스터의 내용을 저장합니다.
  * @ im1_reg : IM1 레지스터의 내용을 저장합니다.
  * @gpio_use_sel_reg : GPIO_USE_SEL 레지스터의 내용을 저장합니다.
  * (ML7223 Bus-n 만 해당)
  */
 ...
 */
/**
  * struct pch_gpio - GPIO 개인 데이터 구조.
  * @base : 메모리 매핑 I / O 레지스터의 PCI 기본 주소.
  * @reg : 메모리 매핑 된 PCH GPIO 레지스터 목록.
  * @dev : 장치 구조의 포인터.
  * @gpio : GPIO 인프라 스트럭처 용 데이터.
  * @pch_gpio_reg : 메모리 매핑 된 레지스터 데이터가 여기에 저장됩니다.
  * 일시 중지.
  * @lock : 레지스터 액세스 보호에 사용됩니다.
