 ...
 * function (Interrupt, Timer, etc).
   GPIO 기능 또는 내부 기능 (인터럽트, 타이머 등)을 위한 GPIO 라인을 구성하십시오.
 */
...
/*
 * Configure the GPIO line as an input. GPIO 라인을 입력으로 구성하십시오.
 */
...
/*
 * Configure the GPIO line as an output, with default state. GPIO 라인을 기본 상태로 출력으로 구성하십시오.
 */
...
/*
 * Set the state of an output GPIO line. 출력 GPIO 라인의 상태를 설정합니다.
 */
...
/*
 * Read the state of a GPIO line.  GPIO 라인의 상태를 읽습니다.
 */
...
/*
 * Map GPIO line to IRQ number.  GPIO 라인을 IRQ 번호에 매핑하십시오.
 */
...
/*
 * Map IRQ number to GPIO line.  IRQ 번호를 GPIO 라인에 매핑하십시오.
 */
