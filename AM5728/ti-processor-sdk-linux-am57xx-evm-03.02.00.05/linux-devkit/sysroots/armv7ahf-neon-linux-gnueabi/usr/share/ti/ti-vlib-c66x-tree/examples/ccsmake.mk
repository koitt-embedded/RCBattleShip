...
# Rule to Build Project HoughLinesDemo_66_LE_ELF

#############################################################

.projects: HoughLinesDemo/HoughLinesDemo_66_LE_ELF

HoughLinesDemo/HoughLinesDemo_66_LE_ELF: HoughLinesDemo/HoughLinesDemo_66_LE_ELF/.project

HoughLinesDemo/HoughLinesDemo_66_LE_ELF/.project: .xdcenv.mak Package.bld Package.mak
	$(ECLIPSE_CMD)  -data "C:/Temp/workspace/HoughLinesDemo_66_LE_ELF" -application com.ti.ccstudio.apps.projectCreate \
 -ccs.name HoughLinesDemo_66_LE_ELF\
 ...
 -ccs.outputType executable -ccs.linkFile EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO/BinImageToEdgelist.c\
 -ccs.linkFile EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO/draw_line.c\
 -ccs.linkFile EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO/hough_wrapper.c\
 -ccs.linkFile EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO/pgmwrite.c\
 -ccs.linkFile EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO/VLIB_testHoughForLines_data.c\
 -ccs.linkFile EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO/lnk.cmd\
 -ccs.setCompilerOptions "-mv6600 -k  -mw --strip_coff_underscore -Dti_targets_elf_C66 --mem_model:data=far -i../../../../packages -g  -i../../../../ -i../../" @configurations Debug -ccs.setCompilerOptions "-mv6600 -k  -mw --strip_coff_underscore -Dti_targets_elf_C66 --mem_model:data=far -i../../../../packages -o3 --symdebug:none  -i../../../../ -i../../" @configurations Release -ccs.location HoughLinesDemo/HoughLinesDemo_66_LE_ELF\
 -ccs.overwrite full \
 -ccs.rts libc.a \
 -ccs.cgtVersion $(CCSCGTVER)\
 -ccs.outputFormat elf\
 -ccs.definePathVariable EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO "C:/nightlybuilds/vlib/ti/vlib/vlib/examples/HoughLinesDemo" \

	echo EXT_ROOT__HOUGHLINESDEMO_66_LE_ELF_HOUGHLINESDEMO=.././ >> HoughLinesDemo/HoughLinesDemo_66_LE_ELF/macros.ini
	-$(RMDIR) "C:/Temp/workspace/HoughLinesDemo_66_LE_ELF"
	-@ echo Project HoughLinesDemo_66_LE_ELF Completed ...
	-@ echo ########################################
	-$(RMDIR) "C:/Temp/workspace/HoughLinesDemo_66_LE_ELF"

clean::
	-$(RMDIR) "HoughLinesDemo/HoughLinesDemo_66_LE_ELF"
...
Regression/RegressionTest_66_LE_ELF/.project: .xdcenv.mak Package.bld Package.mak
 ...
 -ccs.cgtVersion $(CCSCGTVER)\
 -ccs.outputFormat elf\
 -ccs.definePathVariable EXT_ROOT__REGRESSIONTEST_66_LE_ELF_REGRESSION "C:/nightlybuilds/vlib/ti/vlib/vlib/examples/Regression" \
