...
public class ti_csl
{
    ...
    void Settings$$TYPES()
    {
        ...
        if (isCFG) {
            po.addFld("cslVersionString", $$T_Str, "03.03.00.05", "w");
    ...
    void $$SINGLETONS()
    {
        ...
        pkgV.bind("$$qn", "ti.csl.");
        pkgV.bind("$vers", Global.newArray(3, 3, 0, 5));
        ...
        sb.append("}\n");
        sb.append("if ('ti.csl$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.csl$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.csl$$stat$root'];\n");
        sb.append("}\n");
    ...
    void Settings$$SINGLETONS()
    {
        ...
        mcfgs.add("cslVersionString");
        mcfgs.add("useCSLIntcLib");
        ...
        ((Value.Arr)om.findStrict("$modules", "ti.csl")).add(vo);
        vo.bind("$$instflag", 0);
        vo.bind("$$iobjflag", 0);
        vo.bind("$$sizeflag", 1);
        vo.bind("$$dlgflag", 0);
        ...
        vo.bind("$$fxntab", Global.newArray("ti_csl_Settings_Module__startupDone__E"));
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("ti.csl.Settings", "ti.csl"));
        Global.callFxn("init", pkgV);
        ((Value.Obj)om.getv("ti.csl.Settings")).bless();
        ((Value.Arr)om.findStrict("$packages", "ti.csl")).add(pkgV);
    }
