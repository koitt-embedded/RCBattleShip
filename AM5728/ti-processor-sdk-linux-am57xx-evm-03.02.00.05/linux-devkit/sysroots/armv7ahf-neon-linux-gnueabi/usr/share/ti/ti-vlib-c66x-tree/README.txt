VLIB Release Directory Structure
===================================
...
examples    - contains example CCS projects
...
The user guide documents in this directory can be viewed several ways:
 -- docs/VLIB_Users_Manual.chm: Using Microsoft HTML Help file on Windows.
 -- docs/VLIB_Users_Manual.html: Using any web browser.
 -- Using the Eclipse Help viewer from CCSV5.  

The Software Manifest and License information can be viewed at:
 -- docs/VLIB_Software_Manifest.html: Using any web browser.

The Release Notes and its history can be viewed at:
 -- vlib_3_2_1_X_release_notes.html: Using any web browser.
