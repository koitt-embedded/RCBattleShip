...
MEMORY
{
    ...
    CODE_CORE_IPU1_1 (RWX) : org = 0x86800000, len = 0x1000000
    PRIVATE_DATA_CORE_IPU1_1 (RWX) : org = 0x87800000, len = 0x1800000
...
/* Content from edma3_drv_arm_tda2xx_core1_sample_configuro (null): */
...
SECTIONS
{
    .text: load >> CODE_CORE_IPU1_1
    .stack: load > PRIVATE_DATA_CORE_IPU1_1
    GROUP: load > PRIVATE_DATA_CORE_IPU1_1
    {
        .bss:
        .neardata:
        .rodata:
    }
    .binit: load > CODE_CORE_IPU1_1
    .cinit: load > CODE_CORE_IPU1_1
    .init_array: load > CODE_CORE_IPU1_1
    .const: load >> PRIVATE_DATA_CORE_IPU1_1
    .data: load >> PRIVATE_DATA_CORE_IPU1_1
    .fardata: load >> PRIVATE_DATA_CORE_IPU1_1
    .switch: load >> PRIVATE_DATA_CORE_IPU1_1
    .sysmem: load > PRIVATE_DATA_CORE_IPU1_1
    .far: load >> PRIVATE_DATA_CORE_IPU1_1
    .args: load > CODE_CORE_IPU1_1 align = 0x4, fill = 0 {_argsize = 0x0; }
    .cio: load >> PRIVATE_DATA_CORE_IPU1_1
    .ARM.exidx: load > PRIVATE_DATA_CORE_IPU1_1
    .ARM.extab: load >> PRIVATE_DATA_CORE_IPU1_1
    .bootVecs:  type = DSECT
    .resetVecs: load > 0x800
    .vecs: load > 0x800, type = DSECT
    .pinit: load > CODE_CORE_IPU1_1
    .systemHeap: load > PRIVATE_DATA_CORE_IPU1_1
    .stackMemory: load > PRIVATE_DATA_CORE_IPU1_1
    .bss:taskStackSection: load > PRIVATE_DATA_CORE_IPU1_1
    .plt: load > PRIVATE_DATA_CORE_IPU1_1
    .far:NDK_MMBUFFER: load > PRIVATE_DATA_CORE_IPU1_1
    .far:NDK_MMBUFFER1: load > PRIVATE_DATA_CORE_IPU1_1
    .far:NDK_OBJMEM: load > PRIVATE_DATA_CORE_IPU1_1
    .far:NDK_PACKETMEM: load > PRIVATE_DATA_CORE_IPU1_1
    .my_sect_ddr: load > PRIVATE_DATA_CORE_IPU1_1
    .ducatiBoot: load > 0x0
    .ducatiGates: load > 0x7f0, type = NOINIT
    xdc.meta: load > PRIVATE_DATA_CORE_IPU1_1, type = COPY
