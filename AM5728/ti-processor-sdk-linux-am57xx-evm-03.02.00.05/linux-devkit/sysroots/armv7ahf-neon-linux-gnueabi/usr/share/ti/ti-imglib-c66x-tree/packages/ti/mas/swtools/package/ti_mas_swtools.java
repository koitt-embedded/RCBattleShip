...
public class ti_mas_swtools
{
    ...
    {
        // module Version
        om.bind("ti.mas.swtools.Version.MAJOR", 4L);
        om.bind("ti.mas.swtools.Version.MINOR", 6L);
        om.bind("ti.mas.swtools.Version.PATCH", 0L);
        om.bind("ti.mas.swtools.Version.BUILD", 14L);
    ...
    void Version$$TYPES()
    {
        ...
        po.init("ti.mas.swtools.Version.Module", om.findStrict("ti.mas.swtools.IVersion2.Module", "ti.mas.swtools"));
                ...
                po.addFld("BUILD", Proto.Elm.newCNum("(xdc_UInt16)"), 14L, "rh");
    ...
    void $$SINGLETONS()
    {
        ...
        pkgV.bind("$vers", Global.newArray("2, 0, 5, 0"));
