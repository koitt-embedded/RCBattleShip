...
#define ti_csl_Settings___VERS 160
...
xdc__CODESECT(ti_csl_Settings_Module__startupDone__S, "ti_csl_Settings_Module__startupDone__S")
...
{
    return (xdc_Bool)(ti_csl_Settings_Module__diagsMask__C != NULL);
}

/* Module_getMask */
static inline xdc_Bits16 ti_csl_Settings_Module_getMask( void ) 
{
    return ti_csl_Settings_Module__diagsMask__C != NULL ? *ti_csl_Settings_Module__diagsMask__C : (xdc_Bits16)0;
}

/* Module_setMask */
static inline xdc_Void ti_csl_Settings_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_csl_Settings_Module__diagsMask__C != NULL) {
        *ti_csl_Settings_Module__diagsMask__C = mask;
    }
}
