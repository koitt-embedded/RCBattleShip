...
#define F77_xerbla xerbla_
   ...
   #define F77_icamax_sub icamax_
   #define F77_zswap      zswap_
   #define F77_zcopy      zcopy_
   #define F77_zaxpy      zaxpy_
   #define F77_izamax_sub izamax_
   #define F77_sdot_sub   sdot_
   #define F77_ddot_sub   ddot_
   #define F77_dsdot_sub   dsdot_
   ...
   #define F77_cdotu_sub  cdotu_
   #define F77_cdotc_sub  cdotc_
   #define F77_zdotu_sub  zdotu_
   #define F77_zdotc_sub  zdotc_
   #define F77_snrm2_sub  snrm2_
   #define F77_sasum_sub  sasum_
   #define F77_dnrm2_sub  dnrm2_
   #define F77_dasum_sub  dasum_
   #define F77_scnrm2_sub  scnrm2_
   #define F77_scasum_sub  scasum_
   #define F77_dznrm2_sub  dznrm2_
   #define F77_dzasum_sub  dzasum_
   #define F77_sdsdot_sub   sdsdot_
/*
 * Level 2 BLAS
 */
...
/* Single Precision */
   ...
   /*BLIS call (frame/compat/f2c returns int)*/
   int F77_srot(FINT, float *, FINT, float *, FINT, const float *, const float *);
   int F77_srotg(float *,float *,float *,float *);
   int F77_srotm( FINT, float *, FINT, float *, FINT, const float *);
   int F77_srotmg(float *,float *,float *,const float *, float *);
   ...
   float F77_sdot_sub(FINT, const float *, FINT, const float *, FINT);
   float F77_sdsdot_sub( FINT, const float *, const float *, FINT, const float *, FINT);
   void F77_sscal( FINT, const float *, float *, FINT);
   float F77_snrm2_sub( FINT, const float *, FINT);
   float F77_sasum_sub( FINT, const float *, FINT);
   int F77_isamax_sub( FINT, const float * , FINT);

/* Double Precision */
   /*BLIS call (frame/compat/f2c returns int)*/
   int F77_drot(FINT, double *, FINT, double *, FINT, const double *, const double *);
   int F77_drotg(double *,double *,double *,double *);
   int F77_drotm( FINT, double *, FINT, double *, FINT, const double *);
   int F77_drotmg(double *,double *,double *,const double *, double *);
   ...
   double F77_dsdot_sub(FINT, const float *, FINT, const float *, FINT);
   ...
   double F77_dasum_sub( FINT, const double *, FINT);
...
/* Single Complex Precision */
   ...
   scomplex F77_cdotc_sub( FINT, const void *, FINT, const void *, FINT);
   scomplex F77_cdotu_sub( FINT, const void *, FINT, const void *, FINT);
   void F77_cscal( FINT, const void *, void *, FINT);
   int F77_icamax_sub( FINT, const void *, FINT);
   void F77_csscal( FINT, const float *, void *, FINT);
   float F77_scnrm2_sub( FINT, const void *, FINT);
   float F77_scasum_sub( FINT, const void *, FINT);
   /*BLIS call (frame/compat/f2c returns int)*/
   int F77_crotg(void *, void *, float *, void * );
...
/* Double Complex Precision */
   ...
   dcomplex F77_zdotc_sub( FINT, const void *, FINT, const void *, FINT);
   dcomplex F77_zdotu_sub( FINT, const void *, FINT, const void *, FINT);
   void F77_zdscal( FINT, const double *, void *, FINT);
   void F77_zscal( FINT, const void *, void *, FINT);
   double F77_dznrm2_sub( FINT, const void *, FINT);
   double F77_dzasum_sub( FINT, const void *, FINT);
   int F77_izamax_sub( FINT, const void *, FINT);
   /*BLIS call (frame/compat/f2c returns int)*/
   int F77_zrotg(void *, void *, double *, void * );
...
/* Single Precision */
   ...
   int  F77_sgbmv(FCHAR, FINT, FINT, FINT, FINT, const float *,  const float *, FINT, const float *, FINT, const float *, float *, FINT);
   void F77_ssymv(FCHAR, FINT, const float *, const float *, FINT, const float *,  FINT, const float *, float *, FINT);
   int  F77_ssbmv(FCHAR, FINT, FINT, const float *, const float *, FINT, const float *, FINT, const float *, float *, FINT);
   int  F77_sspmv(FCHAR, FINT, const float *, const float *, const float *, FINT, const float *, float *, FINT);
   void F77_strmv( FCHAR, FCHAR, FCHAR, FINT, const float *, FINT, float *, FINT);
   int  F77_stbmv( FCHAR, FCHAR, FCHAR, FINT, FINT, const float *, FINT, float *, FINT);
   int  F77_stpmv( FCHAR, FCHAR, FCHAR, FINT, const float *, float *, FINT);
   void F77_strsv( FCHAR, FCHAR, FCHAR, FINT, const float *, FINT, float *, FINT);
   int  F77_stbsv( FCHAR, FCHAR, FCHAR, FINT, FINT, const float *, FINT, float *, FINT);
   int  F77_stpsv( FCHAR, FCHAR, FCHAR, FINT, const float *, float *, FINT);
   ...
   int  F77_sspr(FCHAR, FINT, const float *, const float *, FINT, float *);
   void F77_ssyr2(FCHAR, FINT, const float *, const float *, FINT, const float *, FINT,  float *, FINT);
   int  F77_sspr2(FCHAR, FINT, const float *, const float *, FINT, const float *, FINT,  float *);


/* Double Precision */

   void F77_dgemv(FCHAR, FINT, FINT, const double *, const double *, FINT, const double *, FINT, const double *, double *, FINT);
   int  F77_dgbmv(FCHAR, FINT, FINT, FINT, FINT, const double *,  const double *, FINT, const double *, FINT, const double *, double *, FINT);
   void F77_dsymv(FCHAR, FINT, const double *, const double *, FINT, const double *,  FINT, const double *, double *, FINT);
   int  F77_dsbmv(FCHAR, FINT, FINT, const double *, const double *, FINT, const double *, FINT, const double *, double *, FINT);
   int  F77_dspmv(FCHAR, FINT, const double *, const double *, const double *, FINT, const double *, double *, FINT);
   void F77_dtrmv( FCHAR, FCHAR, FCHAR, FINT, const double *, FINT, double *, FINT);
   int  F77_dtbmv( FCHAR, FCHAR, FCHAR, FINT, FINT, const double *, FINT, double *, FINT);
   int  F77_dtpmv( FCHAR, FCHAR, FCHAR, FINT, const double *, double *, FINT);
   void F77_dtrsv( FCHAR, FCHAR, FCHAR, FINT, const double *, FINT, double *, FINT);
   int  F77_dtbsv( FCHAR, FCHAR, FCHAR, FINT, FINT, const double *, FINT, double *, FINT);
   int  F77_dtpsv( FCHAR, FCHAR, FCHAR, FINT, const double *, double *, FINT);
   ...
   int  F77_dspr(FCHAR, FINT, const double *, const double *, FINT, double *);
   void F77_dsyr2(FCHAR, FINT, const double *, const double *, FINT, const double *, FINT,  double *, FINT);
   int  F77_dspr2(FCHAR, FINT, const double *, const double *, FINT, const double *, FINT,  double *);


/* Single Complex Precision */

   void F77_cgemv(FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   int  F77_cgbmv(FCHAR, FINT, FINT, FINT, FINT, const void *,  const void *, FINT, const void *, FINT, const void *, void *, FINT);
   void F77_chemv(FCHAR, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   int  F77_chbmv(FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   int  F77_chpmv(FCHAR, FINT, const void *, const void *, const void *, FINT, const void *, void *, FINT);
   void F77_ctrmv( FCHAR, FCHAR, FCHAR, FINT, const void *, FINT, void *, FINT);
   int  F77_ctbmv( FCHAR, FCHAR, FCHAR, FINT, FINT, const void *, FINT, void *, FINT);
   int  F77_ctpmv( FCHAR, FCHAR, FCHAR, FINT, const void *, void *, FINT);
   void F77_ctrsv( FCHAR, FCHAR, FCHAR, FINT, const void *, FINT, void *, FINT);
   int  F77_ctbsv( FCHAR, FCHAR, FCHAR, FINT, FINT, const void *, FINT, void *, FINT);
   int  F77_ctpsv( FCHAR, FCHAR, FCHAR, FINT, const void *, void *,FINT);
   ...
   int  F77_chpr(FCHAR, FINT, const float *, const void *, FINT, void *);
   int  F77_chpr2(FCHAR, FINT, const float *, const void *, FINT, const void *, FINT, void *);

/* Double Complex Precision */

   void F77_zgemv(FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   int  F77_zgbmv(FCHAR, FINT, FINT, FINT, FINT, const void *,  const void *, FINT, const void *, FINT, const void *, void *, FINT);
   void F77_zhemv(FCHAR, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   int  F77_zhbmv(FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   int  F77_zhpmv(FCHAR, FINT, const void *, const void *, const void *, FINT, const void *, void *, FINT);
   void F77_ztrmv( FCHAR, FCHAR, FCHAR, FINT, const void *, FINT, void *, FINT);
   int  F77_ztbmv( FCHAR, FCHAR, FCHAR, FINT, FINT, const void *, FINT, void *, FINT);
   int  F77_ztpmv( FCHAR, FCHAR, FCHAR, FINT, const void *, void *, FINT);
   void F77_ztrsv( FCHAR, FCHAR, FCHAR, FINT, const void *, FINT, void *, FINT);
   int  F77_ztbsv( FCHAR, FCHAR, FCHAR, FINT, FINT, const void *, FINT, void *, FINT);
   int  F77_ztpsv( FCHAR, FCHAR, FCHAR, FINT, const void *, void *,FINT);
   ...
   int  F77_zhpr(FCHAR, FINT, const double *, const void *, FINT, void *);
   int  F77_zhpr2(FCHAR, FINT, const double *, const void *, FINT, const void *, FINT, void *);
...
/* Single Complex Precision */
   ...
   void F77_cgemm(FCHAR, FCHAR, FINT, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   void F77_csymm(FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   void F77_chemm(FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   void F77_csyrk(FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, void *, FINT);
   void F77_cherk(FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, void *, FINT);
   void F77_csyr2k(FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   void F77_cher2k(FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, const void *, FINT, const void *, void *, FINT);
   void F77_ctrmm(FCHAR, FCHAR, FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, void *, FINT);
   void F77_ctrsm(FCHAR, FCHAR, FCHAR, FCHAR, FINT, FINT, const void *, const void *, FINT, void *, FINT);

/* Double Complex Precision */

   void F77_zgemm(FCHAR, FCHAR, FINT, FINT, FINT, const void  *, const void  *, FINT, const void  *, FINT, const void  *, void  *, FINT);
   void F77_zsymm(FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, const void  *, FINT, const void  *, void  *, FINT);
   void F77_zhemm(FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, const void  *, FINT, const void  *, void  *, FINT);
   void F77_zsyrk(FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, const void  *, void  *, FINT);
   void F77_zherk(FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, const void  *, void  *, FINT);
   void F77_zsyr2k(FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, const void  *, FINT, const void  *, void  *, FINT);
   void F77_zher2k(FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, const void  *, FINT, const void  *, void  *, FINT);
   void F77_ztrmm(FCHAR, FCHAR, FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, void  *, FINT);
   void F77_ztrsm(FCHAR, FCHAR, FCHAR, FCHAR, FINT, FINT, const void  *, const void  *, FINT, void  *, FINT);
