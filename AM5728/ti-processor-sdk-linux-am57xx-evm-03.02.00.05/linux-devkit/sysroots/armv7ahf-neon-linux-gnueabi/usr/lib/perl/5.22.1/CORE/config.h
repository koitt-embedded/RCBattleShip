 ...
 */
#define CPPSTDIN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm -mfpu=neon  -mfloat-abi=hard  -E"
#define CPPMINUS "-"
#define CPPRUN "arm-linux-gnueabihf-gcc  -march=armv7-a -marm -mfpu=neon  -mfloat-abi=hard  -E"
#define CPPLAST "-"
