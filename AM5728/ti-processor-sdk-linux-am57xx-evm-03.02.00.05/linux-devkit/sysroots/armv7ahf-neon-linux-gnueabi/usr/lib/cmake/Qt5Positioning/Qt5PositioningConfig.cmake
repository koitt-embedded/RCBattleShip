...
if (NOT TARGET Qt5::Positioning)
    ...
    set(Qt5Positioning_PRIVATE_INCLUDE_DIRS
        "${_qt5Positioning_install_prefix}/include/qt5/QtPositioning/5.6.2"
        "${_qt5Positioning_install_prefix}/include/qt5/QtPositioning/5.6.2/QtPositioning"
    )
    ...
    _populate_Positioning_target_properties(RELEASE "libQt5Positioning.so.5.6.2" "" )
    ...
    macro(_populate_Positioning_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Positioning_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Positioning_check_file_exists(${imported_location})
