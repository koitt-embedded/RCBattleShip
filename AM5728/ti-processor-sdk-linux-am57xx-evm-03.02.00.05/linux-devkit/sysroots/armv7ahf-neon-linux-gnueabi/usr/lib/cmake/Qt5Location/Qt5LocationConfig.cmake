...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Location" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Location_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::Location)
    ...
    set(_Qt5Location_OWN_INCLUDE_DIRS "${_qt5Location_install_prefix}/include/qt5/" "${_qt5Location_install_prefix}/include/qt5/QtLocation")
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/qt5/QtLocation/5.6.2"
        "${_qt5Location_install_prefix}/include/qt5/QtLocation/5.6.2/QtLocation"
    )
    ...
    _populate_Location_target_properties(RELEASE "libQt5Location.so.5.6.2" "" )
    ...
    macro(_populate_Location_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Location_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Location_check_file_exists(${imported_location})
