...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5WebEngineWidgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebEngineWidgets_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::WebEngineWidgets)
    ...
    set(_Qt5WebEngineWidgets_OWN_INCLUDE_DIRS "${_qt5WebEngineWidgets_install_prefix}/include/qt5/" "${_qt5WebEngineWidgets_install_prefix}/include/qt5/QtWebEngineWidgets")
    set(Qt5WebEngineWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineWidgets_install_prefix}/include/qt5/QtWebEngineWidgets/5.6.2"
        "${_qt5WebEngineWidgets_install_prefix}/include/qt5/QtWebEngineWidgets/5.6.2/QtWebEngineWidgets"
    )
    ...
    _populate_WebEngineWidgets_target_properties(RELEASE "libQt5WebEngineWidgets.so.5.6.2" "" )
    ...
    macro(_populate_WebEngineWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebEngineWidgets_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebEngineWidgets_check_file_exists(${imported_location})
