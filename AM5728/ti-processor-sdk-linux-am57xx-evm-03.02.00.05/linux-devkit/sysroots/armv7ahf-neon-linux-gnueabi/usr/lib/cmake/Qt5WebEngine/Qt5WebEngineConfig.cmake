...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5WebEngine" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebEngine_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::WebEngine)
    ...
    set(_Qt5WebEngine_OWN_INCLUDE_DIRS "${_qt5WebEngine_install_prefix}/include/qt5/" "${_qt5WebEngine_install_prefix}/include/qt5/QtWebEngine")
    set(Qt5WebEngine_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngine_install_prefix}/include/qt5/QtWebEngine/5.6.2"
        "${_qt5WebEngine_install_prefix}/include/qt5/QtWebEngine/5.6.2/QtWebEngine"
    )
    ...
    _populate_WebEngine_target_properties(RELEASE "libQt5WebEngine.so.5.6.2" "" )
    ...
    macro(_populate_WebEngine_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebEngine_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebEngine_check_file_exists(${imported_location})
