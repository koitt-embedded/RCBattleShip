...
set(Qt5Compositor_VERSION_STRING 5.6.2)
...
if (NOT TARGET Qt5::Compositor)
    ...
    set(Qt5Compositor_PRIVATE_INCLUDE_DIRS
        "${_qt5Compositor_install_prefix}/include/qt5/QtCompositor/5.6.2"
        "${_qt5Compositor_install_prefix}/include/qt5/QtCompositor/5.6.2/QtCompositor"
    )
    ...
    set(_Qt5Compositor_MODULE_DEPENDENCIES "Quick;Gui;Qml;Core")
    ...
    foreach(_module_dep ${_Qt5Compositor_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.2 ${_Qt5Compositor_FIND_VERSION_EXACT}
    ...
    set(_Qt5Compositor_LIB_DEPENDENCIES "Qt5::Quick;Qt5::Gui;Qt5::Qml;Qt5::Core")
    ...
    _populate_Compositor_target_properties(RELEASE "libQt5Compositor.so.5.6.2" "" )




    file(GLOB pluginTargets "${CMAKE_CURRENT_LIST_DIR}/Qt5Compositor_*Plugin.cmake")

    macro(_populate_Compositor_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        set_property(TARGET Qt5::${Plugin} APPEND PROPERTY IMPORTED_CONFIGURATIONS ${Configuration})

        set(imported_location "${_qt5Compositor_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Compositor_check_file_exists(${imported_location})
