...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5WebChannel" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebChannel_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::WebChannel)
    ...
    set(_Qt5WebChannel_OWN_INCLUDE_DIRS "${_qt5WebChannel_install_prefix}/include/qt5/" "${_qt5WebChannel_install_prefix}/include/qt5/QtWebChannel")
    set(Qt5WebChannel_PRIVATE_INCLUDE_DIRS
        "${_qt5WebChannel_install_prefix}/include/qt5/QtWebChannel/5.6.2"
        "${_qt5WebChannel_install_prefix}/include/qt5/QtWebChannel/5.6.2/QtWebChannel"
    )
    ...
    _populate_WebChannel_target_properties(RELEASE "libQt5WebChannel.so.5.6.2" "" )
    ...
    macro(_populate_WebChannel_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebChannel_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebChannel_check_file_exists(${imported_location})
