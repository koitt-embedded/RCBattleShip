...
if (NOT TARGET Qt5::WebSockets)
    ...
    set(Qt5WebSockets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.6.2"
        "${_qt5WebSockets_install_prefix}/include/qt5/QtWebSockets/5.6.2/QtWebSockets"
    )
    ...
    _populate_WebSockets_target_properties(RELEASE "libQt5WebSockets.so.5.6.2" "" )
    ...
    macro(_populate_WebSockets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebSockets_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebSockets_check_file_exists(${imported_location})
