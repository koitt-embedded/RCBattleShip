...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.6.2"
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.6.2/QtSensors"
    )
    ...
    _populate_Sensors_target_properties(RELEASE "libQt5Sensors.so.5.6.2" "" )
    ...
    macro(_populate_Sensors_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Sensors_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Sensors_check_file_exists(${imported_location})
