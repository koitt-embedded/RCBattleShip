...
if (NOT TARGET Qt5::ScriptTools)
    ...
    set(Qt5ScriptTools_PRIVATE_INCLUDE_DIRS
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.6.2"
        "${_qt5ScriptTools_install_prefix}/include/qt5/QtScriptTools/5.6.2/QtScriptTools"
    )
    ...
    _populate_ScriptTools_target_properties(RELEASE "libQt5ScriptTools.so.5.6.2" "" )
    ...
    macro(_populate_ScriptTools_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5ScriptTools_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_ScriptTools_check_file_exists(${imported_location})
