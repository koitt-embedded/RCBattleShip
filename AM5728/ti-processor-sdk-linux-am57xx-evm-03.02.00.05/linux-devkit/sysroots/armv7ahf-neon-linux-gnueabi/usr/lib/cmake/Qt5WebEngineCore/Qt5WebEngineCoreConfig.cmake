...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5WebEngineCore" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5WebEngineCore_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
if (NOT TARGET Qt5::WebEngineCore)
    ...
    set(_Qt5WebEngineCore_OWN_INCLUDE_DIRS "${_qt5WebEngineCore_install_prefix}/include/qt5/" "${_qt5WebEngineCore_install_prefix}/include/qt5/QtWebEngineCore")
    set(Qt5WebEngineCore_PRIVATE_INCLUDE_DIRS
        "${_qt5WebEngineCore_install_prefix}/include/qt5/QtWebEngineCore/5.6.2"
        "${_qt5WebEngineCore_install_prefix}/include/qt5/QtWebEngineCore/5.6.2/QtWebEngineCore"
    )
    ...
    _populate_WebEngineCore_target_properties(RELEASE "libQt5WebEngineCore.so.5.6.2" "" )
    ...
    macro(_populate_WebEngineCore_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5WebEngineCore_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_WebEngineCore_check_file_exists(${imported_location})
